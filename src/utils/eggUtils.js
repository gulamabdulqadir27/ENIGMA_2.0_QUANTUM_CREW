// feat: add EEG signal generation and analysis utilities
// All synthetic EEG data is generated here using seeded random numbers
// so results are fully reproducible per seed value
...
export function generateSHAPValues(isSZ, seed) {
  ...
  const szSign = { alpha: -1, delta: 1, theta: 1, gamma: 1, coh: -1 };
  const hSign  = { alpha: 1,  delta: -1, theta: -1, gamma: -1, coh: 1 };
  const szMag  = { alpha: [0.15, 0.35], delta: [0.10, 0.28], theta: [0.08, 0.20], gamma: [0.08, 0.22], coh: [0.08, 0.18] };
  const hMag   = { alpha: [0.05, 0.15], delta: [0.03, 0.10], theta: [0.03, 0.08], gamma: [0.03, 0.08], coh: [0.03, 0.10] };
